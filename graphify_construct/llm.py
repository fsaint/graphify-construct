...
_EXTRACTION_SYSTEM = """\
You are extracting a knowledge graph from a construction project's documents.
...
Temporal: whenever a date appears, populate start_date, due_date, or completed_at
in ISO-8601 (YYYY-MM-DD). For tasks, fill duration_days and predecessors[] when
the source states or implies ordering ("after foundation cures", "pending permit
approval").

Node ID format: lowercase [a-z0-9_] only, {stem}_{entity}.
Prefer the most specific named entity. Use AMBIGUOUS over dropping uncertain entities.

Output schema:
{"nodes":[{"id":"...","label":"...","file_type":"task","source_file":"...","source_location":null,"start_date":null,"due_date":null,"completed_at":null,"duration_days":null,"predecessors":[],"responsible_party":null,"author":null,"contributor":null}],"edges":[{"source":"...","target":"...","relation":"responsible_for","confidence":"EXTRACTED","confidence_score":1.0,"source_file":"...","source_location":null,"weight":1.0}],"hyperedges":[],"input_tokens":0,"output_tokens":0}
"""

_DEEP_EXTRACTION_SUFFIX = """\

DEEP_MODE: include additional INFERRED edges only for concrete project signals
(shared schedule dependencies, explicit contract obligations, or multi-step flow
