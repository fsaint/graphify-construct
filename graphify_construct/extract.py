...
def extract_bash(path: Path) -> dict:
    ...
    from graphify_construct.security import sanitize_metadata  # module-level cached import
...
def collect_files(target: Path, *, follow_symlinks: bool = False, root: Path | None = None) -> list[Path]:
    ...
    from graphify_construct.detect import _load_graphifyignore, _is_ignored, _is_noise_dir
