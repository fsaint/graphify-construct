...
from graphify_construct.google_workspace import (
...
# Construction / BIM binary formats — never readable as text; skip entirely
BINARY_CAD_EXTENSIONS = {'.dwg', '.rvt', '.ifc'}
...
def classify_file(path: Path) -> FileType | None:
    ...
    if ext in BINARY_CAD_EXTENSIONS:
        return None  # construction BIM/CAD binaries — always skip
