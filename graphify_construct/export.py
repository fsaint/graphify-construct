...
from graphify_construct.analyze import _node_community_map
...
def to_html(
    ...
    for node_id, data in G.nodes(data=True):
        ...
        color = FILE_TYPE_COLORS.get(data.get("file_type", ""), "#a3a3a3")
    ...
    legend_data = [
        {"cid": i, "color": color, "label": _html.escape(ftype), "count": 0}
        for i, (ftype, color) in enumerate(FILE_TYPE_COLORS.items())
    ]
...
def to_obsidian(
    ...
    _FTYPE_TAG = {
        "task":        "graphify/task",
        "deadline":    "graphify/deadline",
        "person":      "graphify/person",
        "institution": "graphify/institution",
        "building":    "graphify/building",
        "location":    "graphify/location",
        "equipment":   "graphify/equipment",
        "permit":      "graphify/permit",
