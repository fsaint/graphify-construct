...
def _rebuild_code(
    ...
    *,
    ...
    try:
        from graphify_construct.extract import extract, _get_extractor
        from graphify_construct.detect import detect
        from graphify_construct.build import build_from_json, _norm_source_file as _nsf
        from graphify_construct.cluster import cluster, remap_communities_to_previous, score_all
        ...
        if no_cluster:
            ...
            try:
                from graphify_construct.detect import save_manifest
        ...
        if callflow_files and not no_change:
            try:
                from graphify_construct.callflow_html import write_callflow_html
